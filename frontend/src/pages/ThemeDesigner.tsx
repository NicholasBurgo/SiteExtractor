    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <h1 className="text-2xl font-semibold text-gray-900">Theme Designer</h1>
          <p className="text-sm text-gray-600 mt-1">Select a theme design for your generated site</p>
        </div>
