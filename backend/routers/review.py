...
async def get_confirmed(run_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error loading confirmed draft: {str(e)}"
        )
...
async def get_run_summary(run_id: str):
    ...
    **Example Response:**
    ...
    try:
        ...
        high_confidence = sum(
            1
            for item in draft.services + draft.products + draft.locations + draft.team
        ...
        total_words = sum(
            ...
            for item in draft.services + draft.products + draft.team
        )
        ...
        return {
            ...
            "pages": {
                ...
                "types": {"html": len(meta_data.get("pages", [])), "pdf": 0, "docx": 0},
            },
            "extraction": {
