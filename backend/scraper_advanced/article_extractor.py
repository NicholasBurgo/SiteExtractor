...
class ArticleExtractor:
    ...
    def extract_article(
        self, html_content: str, url: str, site_name: str = None
    ) -> Dict[str, Any]:
        """
    ...
    def _extract_with_trafilatura(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            article_data = {
                ...
                or self._extract_title_fallback(html_content),
                "content": extracted,
    ...
    def _extract_with_bs4(
        ...
        article_data["content"] = self._extract_content(
            soup, selectors.get("article_selectors", [])
        )

        # Extract author
        article_data["author"] = self._extract_author(
            soup, selectors.get("author_selectors", [])
        )

        # Extract date
        article_data["publish_date"] = self._extract_date(
            soup, selectors.get("date_selectors", [])
        )
    ...
    def _extract_content(
        self, soup: BeautifulSoup, article_selectors: List[str]
    ) -> Optional[str]:
    ...
    def _extract_author(
        self, soup: BeautifulSoup, author_selectors: List[str]
    ) -> Optional[str]:
    ...
    def _extract_date(
        self, soup: BeautifulSoup, date_selectors: List[str]
    ) -> Optional[str]:
    ...
    def _post_process_article(
        self, article_data: Dict[str, Any], url: str, site_name: str = None
    ) -> Dict[str, Any]:
