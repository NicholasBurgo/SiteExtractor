...
class TestNormalizeUrl:
    ...
    def test_decodes_percent_encoding(self):
        assert normalize_url("https://example.com/%41bout") == "https://example.com/About"
...
class TestMakePageId:
    ...
    def test_ignores_trailing_slash(self):
        ...
        assert make_page_id("https://example.com/about") == make_page_id("https://example.com/about/")

    def test_ignores_fragment(self):
        """Fragment removal means these produce the same ID."""
        assert make_page_id("https://example.com/page") == make_page_id("https://example.com/page#section")

    def test_case_insensitive_host(self):
        """Host case normalization means these produce the same ID."""
        assert make_page_id("https://Example.COM/path") == make_page_id("https://example.com/path")
