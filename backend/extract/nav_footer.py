        ...
        for i, li in enumerate(lis):
            ...
            if child_links:
                ...
                for j, child_link in enumerate(child_links):
                    ...
                    child_href = (
                        to_abs(child_link["href"]) if child_link.get("href") else ""
                    )
...
def extract_footer(soup: BeautifulSoup, base_url: str) -> Dict[str, Any]:
    ...
    """
    footer_data = {"columns": [], "socials": [], "contact": {}}
    ...
    for element in footer_element.find_all(
        ...
        if element.name in ["h1", "h2", "h3", "h4", "h5", "h6"]:
            ...
            current_column = {"heading": element.get_text().strip(), "links": []}
            ...
            if label and href:
                current_column["links"].append({"label": label, "href": href})
